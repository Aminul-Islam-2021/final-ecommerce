...
} from "../../store/features/category/subCategoryApi";
                ...
                <div className="flex gap-2">
                  {editingItem.id === category._id &&
                    ...
                    <>
                      ...
                      >
                        <FiFolderPlus onClick={() => toggleCategory(category._id)} />
                      </button>
                      <button
                        onClick={() =>
    ...
    <div className="mt-2 ml-8 pl-4 border-l-2 border-blue-200">
      ...
      {isLoading ? (
        <div className="flex justify-center py-2">
          <div className="animate-spin rounded-full h-6 w-6 border-t-1 border-b-1 border-blue-500"></div>
        </div>
      ) : error ? (
